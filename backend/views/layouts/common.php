            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo Yii::$app->urlManager->createUrl('/img/user.jpg') ?>" class="user-image">
                            <span><?php echo Yii::$app->user->identity->username ?> <i class="caret"></i></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header light-blue">
                                <img src="<?php echo Yii::$app->urlManager->createUrl('/img/user.jpg') ?>" class="img-circle" alt="User Image" />
                                <p>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php echo Yii::$app->urlManager->createUrl('/img/user.jpg') ?>" class="img-circle" />
                </div>
            ...
            echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        ...
                        'items' => [
                            [
                                'label' => Yii::t('backend', 'Server Connections'),
